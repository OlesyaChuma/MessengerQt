...
- **Звуковое уведомление о новых сообщениях** с возможностью отключения
...
- **Звуки:** `notify.wav` — источник: [Sound Pack](https://sound-pack.net/) —   свободный звук для использования в учебных целях
